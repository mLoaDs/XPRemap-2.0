...
"%BINARYPATH%\cl.exe" /c /Zi /nologo /W3 /WX- /Ox /Os /D NDEBUG /D _XBOX /GF /Gm- /MT /GS- /Gy /fp:fast /fp:except- /Zc:wchar_t /Zc:forScope /GR- /openmp- /Fo"%BUILD_DIR%/" /Fd"%BUILD_DIR%/" /FI"%XEDK%/include/xbox/xbox_intellisense_platform.h" /TP %SOURCEFILE%.cc
